...
const Navbar: React.FC<NavbarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <nav className="w-full shadow-xl flex flex-col items-center
      /* MÓVIL: Degradado arriba-abajo y más alto para que entren los botones */
      bg-gradient-to-b from-[#125287] via-[#65A9CC] to-[#24D6EA] py-2 gap-0
      
      /* ESCRITORIO: Volvemos a fila única y degradado lateral */
      md:flex-row md:h-20 md:bg-gradient-to-r md:from-[#125287] md:via-[#65A9CC] md:to-[#0C9FAF] md:py-0 md:px-6 md:justify-between"
    >
      ...
      <div className="w-full flex justify-center items-center md:w-auto md:justify-start">
        <img 
          src={logo} 
          alt="Logo ServiBus" 
          /* MÓVIL: Ocupa el 85% del ancho y se centra gracias al div de arriba.
             ESCRITORIO: Vuelve a tamaño fijo y alineación a la izquierda.
          */
          className="w-[85%] max-w-[320px] h-auto md:w-auto md:h-20" 
        />
      </div>

      {/* 2. MENÚ DE NAVEGACIÓN (Abajo del logo en móvil) */}
      ...
      {/* 3. BOTÓN DE ACCIÓN (Solo aparece en PC) */}
